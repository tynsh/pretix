...
urlpatterns = [
    ...
    url(r'^organizer/(?P<organizer>[^/]+)/seatingplans$', organizer.SeatingPlanListView.as_view(), name='organizer.seatingplans'),
    url(r'^organizer/(?P<organizer>[^/]+)/seatingplans/add$', organizer.SeatingPlanCreateView.as_view(), name='organizer.seatingplan.add'),
    url(r'^organizer/(?P<organizer>[^/]+)/seatingplans/(?P<plan>[^/]+)/edit$', organizer.SeatingPlanUpdateView.as_view(),
        name='organizer.seatingplan.edit'),
    url(r'^organizer/(?P<organizer>[^/]+)/seatingplans/(?P<plan>[^/]+)/delete$', organizer.SeatingPlanDeleteView.as_view(),
        name='organizer.seatingplan.delete'),
    ...
    url(r'^event/(?P<organizer>[^/]+)/(?P<event>[^/]+)/', include([
        ...
        url(r'^settings/seating/mappingform$', event.SeatingMapFormView.as_view(), name='event.settings.seating.mapform'),
        ...
        url(r'^subevents/(?P<subevent>\d+)/mappingform$', subevents.SeatingMapFormView.as_view(), name='event.subevents.seating.mapform'),
        url(r'^subevents/mappingform$', subevents.SeatingMapFormView.as_view(), name='event.subevents.seating.mapform'),
